...
import com.example.wpchat.adapters.RecentMessageAdapter;
import com.example.wpchat.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void init(){
        ...
        recentMessageAdapter = new RecentMessageAdapter(conversations,this);
        binding.recentConvoRecyclerView.setAdapter(recentMessageAdapter);
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if (value != null){
            ...
            binding.recentConvoRecyclerView.smoothScrollToPosition(0);
            binding.recentConvoRecyclerView.setVisibility(View.VISIBLE);
